...
const articleTemplate = __webpack_require__(3);
const paginationTemplate = __webpack_require__(4);
const commentTemplae = __webpack_require__(5);
const  getInputValuesArrayFromForm  = __webpack_require__(6).arrayToObj;
...
module.exports = "<% for(let i = 1; i<number+1;i++){ %>" +
